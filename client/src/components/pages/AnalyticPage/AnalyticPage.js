...
class AnalyticPage extends PureComponent {
    ...
    async componentDidMount() {
        await this.props.getDataFromAnalytic({ page: this.state.page, sort_field: this.state.sort_field, sort_direction: this.state.sort_direction });
    }
    ...
    render() {
        ...
        return (
            <div className={'analyticPageWrapper'}>
                {isLoading ?
                    <Progress size={40} />
                    : this.renderContent()
                }
